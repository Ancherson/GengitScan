...
//            System.out.println(log);
   ...
   This test won't pass since to fix the issue #41 we changed the attribute "date" of Commit from String to LocalDateTime, and the toString() method isn't the same
   */
